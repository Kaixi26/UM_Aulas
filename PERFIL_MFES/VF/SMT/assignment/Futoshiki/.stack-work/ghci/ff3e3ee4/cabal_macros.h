...
/* package Futoshiki-0.1.0.0 */
#ifndef VERSION_Futoshiki
#define VERSION_Futoshiki "0.1.0.0"
#endif /* VERSION_Futoshiki */
#ifndef MIN_VERSION_Futoshiki
#define MIN_VERSION_Futoshiki(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Futoshiki */
...
#define CURRENT_COMPONENT_ID "Futoshiki-0.1.0.0-9JUNDZQaPFD1xBSynDvUsO-Futoshiki"
